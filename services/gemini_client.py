...
FALLBACK_SAFETY_PROTOCOL = SafetyProtocol(
    ...
    first_aid_steps=[
        ...
        "Call campus emergency dispatch or local emergency services.",
    ...
    translated_warning="Emergency warning: Move away from the hazard immediately and contact campus emergency services.",
)
...
async def analyze_hazard(report: IncidentReport) -> SafetyProtocol:
    ...
    try:
        ...
        if response.text:
            return SafetyProtocol.model_validate_json(response.text)
